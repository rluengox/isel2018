...
//Funciones de guarda del interruptor
...
//Funciones de accion del interruptor
...
//Funciones de guarda de la alarma
...
//Funciones de accion de la alarma
...
void alarm(void* ignore)
{
    ...
    alarm_shut(fsm1);
    fsm_t* fsm2 = fsm_new(interruptor);
    led_off(fsm2);
